...
```bash
wget -q -O - https://github.com/nosebit/act/releases/download/v1.1.3/act-1.1.3-linux-amd64.tar.gz | tar -xzf - -C /usr/local/bin
```

**MacOS**

```bash
wget -q -O - https://github.com/nosebit/act/releases/download/v1.1.3/act-1.1.3-darwin-amd64.tar.gz | tar -xzf - -C /usr/local/bin
```
