...
```bash
wget -q -O - https://github.com/nosebit/act/releases/download/v1.1.2/act-1.1.2-linux-amd64.tar.gz | sudo tar -xzf - -C /usr/local/bin
```

**MacOS**

```bash
wget -q -O - https://github.com/nosebit/act/releases/download/v1.1.2/act-1.1.2-darwin-amd64.tar.gz | sudo tar -xzf - -C /usr/local/bin
```
